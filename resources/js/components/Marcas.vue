    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <card-component titulo="Procure Produtos por Nome ou ID">
                ...
                <card-component titulo="Produtos Cadastrados">
                    <template v-slot:conteudo>
                        <table-component
                            :dados="marcas.data"
                            :visualizar="{
            ...
            <template v-slot:conteudo>
                ...
                <div class="form-group">
                    <input-container-component
                        ...
                        id="novoPreco"
                        id-help="novoNomeHelp"
                        texto-ajuda="Informe o preco do produto"
                    >
                        <input
                            type="text"
                            class="form-control"
                ...
                <div class="form-group">
                    <input-container-component
                        ...
                        id="novoEstoque"
                        id-help="novoNomeHelp"
                        texto-ajuda="Informe o estoque do produto"
                    >
                        <input
                            type="text"
                            class="form-control"
                ...
                <div class="form-group">
                    ...
                    >
                        <input
                            ...
                            aria-describedby="atualizarNomeHelp"
                            placeholder="Preco do produto"
                            v-model="$store.state.item.preco"
                        />
                    </input-container-component>
                </div>
                <div class="form-group">
                    ...
                    >
                        <input
                            ...
                            aria-describedby="atualizarNomeHelp"
                            placeholder="Estoque"
                            v-model="$store.state.item.estoque"
                        />
                    </input-container-component>
                </div>
...
export default {
    ...
    methods: {
        atualizar() {
            ...
            formData.append("preco", this.$store.state.item.preco);
        ...
        salvar() {
            ...
            formData.append("preco", this.precoMarca);
            formData.append("estoque", this.estoqueMarca);
            formData.append("imagem", this.arquivoImagem[0]);
